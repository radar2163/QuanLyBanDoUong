package com.example.cuoiki.XuatKho;
...
public class ExportnActivity extends AppCompatActivity {

    private Spinner spinnerProduct;
    private Button btnExportProduct, btnclose;
    private SQLiteDatabase db;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_exportn);

        spinnerProduct = findViewById(R.id.product_spinner);
        btnExportProduct = findViewById(R.id.searchButton);
        ...
        btnExportProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String quantityText = editTextText2.getText().toString().trim();
                if (quantityText.isEmpty()) {
                    Toast.makeText(ExportnActivity.this, "Vui lòng nhập số lượng", Toast.LENGTH_SHORT).show();
                    return;
                }
                int addedQuantity = Integer.parseInt(quantityText);
                exportProductQuantity(selectedProduct, addedQuantity);
    ...
    private void exportProductQuantity(String productName, int addedQuantity) {
        Cursor cursor = null;
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                if (idColumnIndex != -1 && quantityColumnIndex != -1) {
                    ...
                    if (addedQuantity <= 0) {
                        Toast.makeText(this, "Số lượng xuất phải lớn hơn 0", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    if (addedQuantity > currentQuantity) {
                        Toast.makeText(this, "Không đủ hàng để xuất. Tồn kho: " + currentQuantity, Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    if (rowsUpdated > 0) {
                        ...
                        transactionValues.put("transaction_type", "Xuất");
